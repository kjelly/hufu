	...
	for _, fixture := range fixtures {
		t.Run(fixture.Name, func(t *testing.T) {
			...
			if fixture.Role == "coordinator" {
				...
				c.compileShadowWorker(context.Background(), WorkerContextInput{TaskGoal: fixture.Goal, RawSTM: fixture.STM, RawLTM: fixture.LTM, ModelContext: spec, MaxAuxChars: 1200}, fixture.LegacyPrompt)
			}
