...
func TestApprovedMemoryPolicyLoadsIntoRuntime(t *testing.T) {
	...
	if c.memoryRankingPolicy.TopK != 7 || c.memoryRankingPolicy.MinimumRelevance != 0.2 || c.memoryRankingPolicy.UtilityWeight != 0.7 || c.memoryRankingPolicy.FreshnessWeight != 0.8 {
