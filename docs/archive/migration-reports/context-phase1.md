...
> Status: superseded
> Authority: reference
> Verified-Commit: historical Phase 1 report
> Superseded-By: [canonical context schema](../../reference/context-sqlite-schema.md)
...
[`context-sqlite-schema.md`](../../reference/context-sqlite-schema.md).
