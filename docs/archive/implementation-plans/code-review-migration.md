...
> Status: archived
> Authority: reference
> Verified-Commit: historical migration plan
> Superseded-By: [hufu-code-review team definition](../../../.agent-teams/hufu-code-review/team.yaml)

> 狀態：提案
> 類型：consumer-specific migration plan
> Runtime 前置計畫：[generic workset archive](generic-workset-evidence.md)
...
- [通用 runtime archive](generic-workset-evidence.md)的WP-1至WP-5已完成；
