...
> Supersedes: the pre-canonical-memory promotion proposals
> Superseded-By: —

本文件描述目前 `hufu context promotion` 的 review-gated contract；若
程式碼與本文件不一致，以 `cmd/hufu`、`internal/promotion`、測試及
canonical context schema 為準。
